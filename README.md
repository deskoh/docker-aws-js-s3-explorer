...
Docker image for [AWS JavaScript S3 Explorer](https://github.com/awslabs/aws-js-s3-explorer) based on [RedHat ubi-minimal](https://developers.redhat.com/products/rhel/ubi/) with selected NGINX CIS Benchmarks.
