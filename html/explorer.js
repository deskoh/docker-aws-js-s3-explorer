...
function SharedService($rootScope) {
    ...
    shared.changeSettings = (settings) => {
        ...
        const endpoint = new AWS.Endpoint(settings.endpoint);
        AWS.config.update({ endpoint, s3ForcePathStyle: true });
...
function SettingsController($scope, SharedService) {
    ...
    $scope.settings = {
        endpoint: 'http://localhost:7480', auth: 'auth', region: '', bucket: '', entered_bucket: '', selected_bucket: '', view: 'folder', delimiter: '/', prefix: '',
    };
